...
{
    public class SqlServerHandle : DbHandleBase
    {
        #region 初始化必须
        /// <summary>
        ///初始化，需要传入连接字符串
        ...
        /// <returns></returns>
        public SqlServerHandle(string conStr) : base(conStr)
        {
        }
        ...
        {
            return strSql.Replace(':', '@');//如果写法确定，则直接return strSql;
        }
