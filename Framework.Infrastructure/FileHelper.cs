...
namespace Framework.Infrastructure
{
    public class FileHelper
    {
        ...
        public static void CreateFile(string dir, string pagestr)
        {
            ...
            StreamWriter sw = new StreamWriter(HttpContext.Current.Request.PhysicalApplicationPath + "\\" + dir, false, System.Text.Encoding.GetEncoding("GB2312"));
            sw.Write(pagestr);
            sw.Close();
        }
        /// <summary>
        ...
        public static void CopyFile(string dir1, string dir2)
        {
            ...
            {
                File.Copy(HttpContext.Current.Request.PhysicalApplicationPath + "\\" + dir1, System.Web.HttpContext.Current.Request.PhysicalApplicationPath + "\\" + dir2, true);
            }
        }
        #endregion
